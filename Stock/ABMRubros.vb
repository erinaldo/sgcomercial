Public Class ABMRubros
    Private Sub RubrosBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
    ...
    Private Sub GroupABM_Enter(sender As Object, e As EventArgs) Handles GroupABM.Enter
    ...
    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles BtnEditar.Click
        If RubrosBindingSource.Count = 0 Then
    ...
    Private Sub BtnCancelar_Click(sender As Object, e As EventArgs) Handles BtnCancelar.Click
        enabledit(False)
        enablefields(False)
        RubrosBindingSource.ResetBindings(True)
