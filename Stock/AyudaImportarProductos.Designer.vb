...
Partial Class AyudaImportarProductos
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(AyudaImportarProductos))
        ...
        Me.Label2.Text = "** IMPORTANTE: NO se permiten campos nulos **"
        '
        'Label1
        '
