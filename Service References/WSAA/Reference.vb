...
Namespace WSAA
    ...
    Public Interface LoginCMS
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="", ReplyAction:="*")>  _
        Function loginCmsAsync(ByVal request As WSAA.loginCmsRequest) As System.Threading.Tasks.Task(Of WSAA.loginCmsResponse)
    End Interface
    ...
    Partial Public Class LoginCMSClient
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function WSAA_LoginCMS_loginCmsAsync(ByVal request As WSAA.loginCmsRequest) As System.Threading.Tasks.Task(Of WSAA.loginCmsResponse) Implements WSAA.LoginCMS.loginCmsAsync
            Return MyBase.Channel.loginCmsAsync(request)
        End Function
        
        Public Function loginCmsAsync(ByVal in0 As String) As System.Threading.Tasks.Task(Of WSAA.loginCmsResponse)
            Dim inValue As WSAA.loginCmsRequest = New WSAA.loginCmsRequest()
            inValue.in0 = in0
            Return CType(Me,WSAA.LoginCMS).loginCmsAsync(inValue)
        End Function
    End Class
End Namespace
