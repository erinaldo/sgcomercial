Public NotInheritable Class SplashSC
    ...
    Private Sub SplashSC_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Version.Text = System.IO.Path.GetFileNameWithoutExtension(My.Application.Info.AssemblyName)
