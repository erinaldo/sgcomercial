Public Class WinPopUp
    ...
    Private Sub WinPopUp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Location = New Point(Screen.PrimaryScreen.Bounds.Width - 300, Screen.PrimaryScreen.Bounds.Height - 80)
    End Sub
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        End If
        '*************************************
        If Not Me.Location.Y = Screen.PrimaryScreen.WorkingArea.Height - 180 Then
